...
if(isset($_GET['product_id'])){
  ...
  $stmt-> execute();
  $result = $stmt-> get_result(); //return [1]
}
...
<body>
    ...
    <!-- <nav class="navbar navbar-expand-lg navbar-light bg-light py-3 fixed-top"> -->
      ...
      <!-- Related products (same as Featured)-->
    ...
    <!-- USE JAVASCRIPT to display the pressed image -->
    <script>
      
      var mainImg = document.getElementById("mainImg"); /* return the main image*/
      var smallImg = document.getElementsByClassName("small-img"); /*return array of small images*/
